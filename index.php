        ...
        <div class="hero-container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    ...
                    <a href="Signup.php" class="btn-secondary">Register as Employee</a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>Comprehensive user and employee management system with role-based access control</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Efficiently manage your product catalog with detailed tracking and categorization</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Streamline order processing from creation to delivery with real-time status updates</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Maintain strong supplier relationships with comprehensive vendor management tools</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Track shipments and deliveries with real-time updates and status monitoring</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Generate comprehensive financial reports and analytics for better business insights</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="steps-grid">
                <div class="step-card">
                    ...
                    <p>Create your employee account or login with your credentials to access the system</p>
                </div>
                <div class="step-card">
                    <div class="step-number">2</div>
                    <h3>Manage Inventory</h3>
                    <p>Add, update, and track your products, suppliers, and orders through our intuitive interface</p>
                </div>
                <div class="step-card">
